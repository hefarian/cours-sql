...
(function () {
    ...
    function debut() {
        ...
        choix1.append("<br>");
        choix1.append($("<button class='btn btn-light'>").html("TP numéro 1").click(function () { lancementCours("tpnoté1"); }));
        ...
        choix2.append("<br>");
        choix2.append($("<button class='btn btn-light'>").html("TP numéro 2").click(function () { lancementCours("tpnoté2"); }));
