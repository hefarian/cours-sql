...
(function () {
    ...
    function debut() {
        var choix = $("<div>").attr("id", "choixAccueil").attr("class", "row"),
            choixGauche = $("<div>").attr("class", "col-sm"), //.attr("id", "choixGauche")
            choixDroite = $("<div>").attr("class", "col-sm"); //.attr("id", "choixDroite")
        ecran.children().remove();
        $("#titre").html("");
        $("#bdd").html("");
        $("#lancer").css("visibility", "hidden");
        ...
        choixGauche.append($("<button class='btn btn-primary'>").html("1 - Requêtage simple").click(function () { lancementCours("1-requetage-simple"); }));
        choixGauche.append("<br>");
        choixGauche.append($("<button class='btn btn-primary'>").html("2 - Calculs et fonctions").click(function () { lancementCours("2-calculs-fonctions"); }));
        choixGauche.append("<br>");
        choixGauche.append($("<button class='btn btn-primary'>").html("3 - Agrégats").click(function () { lancementCours("3-agrégats"); }));
        choixGauche.append("<br>");
        choixGauche.append($("<button class='btn btn-info'>").html("Récapitulatif 1").click(function () { lancementCours("recapitulatif1"); }));
        choixGauche.append("<br>");
        choixGauche.append($("<button class='btn btn-light'>").html("TP noté 1").click(function () { lancementCours("tpnot1"); }));

        choixDroite.append($("<button class='btn btn-primary'>").html("4 - Jointures").click(function () { lancementCours("4-jointures"); }));
        choixDroite.append("<br>");
        choixDroite.append($("<button class='btn btn-primary'>").html("5 - Sous-requêtes").click(function () { lancementCours("5-sous-requetes"); }));
        choixDroite.append("<br>");
        choixDroite.append($("<button class='btn btn-primary'>").html("6 - Opérations ensemblistes").click(function () { lancementCours("6-ensemblistes"); }));
        choixDroite.append("<br>");
        choixDroite.append($("<button class='btn btn-info'>").html("Récapitulatif 2").click(function () { lancementCours("recapitulatif2"); }));
        choixDroite.append("<br>");
        choixDroite.append($("<button class='btn btn-primary'>").html("7 - Fenêtrage").click(function () { lancementCours("7-fenetrage"); }));
        choixDroite.append("<br>");
        choixDroite.append($("<button class='btn btn-light'>").html("TP noté 2").click(function () { lancementCours("tpnoté2"); }));
