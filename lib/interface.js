...
(function () {
    ...
    function debut() {
        ...
        choix1.append("<br>");
        choix1.append($("<button class='btn btn-primary'>").html("3 - Agrégats").click(function () { lancementCours("3-agrégats"); }));
        choix1.append("<br>");
        choix1.append($("<button class='btn btn-info'>").html("Récapitulatif 1").click(function () { lancementCours("recapitulatif1"); }));
        choix1.append("<br>");
        choix1.append($("<button class='btn btn-light'>").html("TP noté 1").click(function () { lancementCours("tpnot1"); }));
        ...
        choix2.append("<br>");
        choix2.append($("<button class='btn btn-light'>").html("TP noté 2").click(function () { lancementCours("tpnoté2"); }));
        
        choix3.append($("<button class='btn btn-primary'>").html("7 - Fenêtrage").click(function () { lancementCours("7-fenetrage"); }));
        choix3.append("<br>");
        choix3.append($("<button class='btn btn-primary-outline'>").html("8 - Vues").click(function () { lancementCours("8-vues"); }));
        choix3.append("<br>");
